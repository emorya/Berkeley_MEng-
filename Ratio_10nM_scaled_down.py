...
# Scaffold 84 nM working stock (tube A2):
    ...
    # Pipette vol per reaction: 10 uL -> 20 nM final in 24 uL
#
# MQ water (tube A3):
...
#    5x batch: 23.10 uL 10x TAE with 12.5mM MgCl2 + 55.00 uL scaffold = 78.10 uL
...
CONDITION_VOLS = [
    (20, "1:1",   20, "master", 2.15, 13.74),
    (20, "1:2.5", 50, "master", 5.38, 10.51),
    (20, "1:3.5", 70, "master", 7.53, 8.36),
    (20, "1:5", 100, "master", 10.76, 5.13),
]


CONDITION_TUBE_WELLS = ['B1','B2','B3','B4']
MASTER_MIX_VOL = 8.11  # uL per condition (2.40 + 5.71 scaffold)
TOTAL_VOL = 24.00
...
#     # ==================================================================
    ...
    #5x batch: 12 uL buffer + 28.55 uL scaffold = 40.55 uL total
    protocol.comment("=== Step 1: Build master mix in A6 ===")

    p300_xfer(12, buffer10x_tube, master_mix_tube)
    p300_xfer(28.55, scaffold_src, master_mix_tube)

    p300.pick_up_tip()
    p300.mix(3, 30, master_mix_tube.bottom(1))
...
#     # ==================================================================
    ...
    # Transfer 15 uL sample to TC plate
        p20.pick_up_tip()
        p20.aspirate(12, src.bottom(1))
        p20.dispense(12, tc_dest_wells[i].bottom(2))
